 ...
 * @notice Badge contract is a minimalist soulbound ERC-721 implementation which is
 *         controlled by the BadgeAdmin contract. The owner of the Badge contract can
 *         set or update the BadgeAdmin.
