...
contract L2OutputOracle is OwnableUpgradeable, Semver {
    ...
    modifier onlySequencer() {
        require(
            ...
            "L2OutputOracle: function can only be called by sequencer"
        );
        _;
    }
    ...
    function appendL2Output(
        ...
        require(
            ...
            "L2OutputOracle: cannot append L2 output in the future"
        );
    ...
    function changeSequencer(address _newSequencer) public onlyOwner {
        require(
            _newSequencer != address(0),
            "L2OutputOracle: new sequencer cannot be the zero address"
        );

        require(
            _newSequencer != owner(),
            "L2OutputOracle: sequencer cannot be the same as the owner"
        );
